...
manifest=json.load(open(ROOT+'/docs/player-combat-revision/player-video-candidate-manifest.json'));curve=manifest['clips'].get(clip,{}).get('travelCurve',[]);direction=manifest['clips'].get(clip,{}).get('direction');baseRig=rig.matrix_world.copy()
def distance(t):
