"""V78 derivative: actual boot support, captured knee planes, unchanged upper body.
...
TAG=os.environ.get('VESPER_FOOT_TAG','v78-slam-safe-backstep')
...
paths={
 'Left':[(0,idle['Left'],yaws['Left'][0]),(18,Vector((-.10,.42,0)),yaws['Left'][30]),(126,Vector((-.10,.42,0)),yaws['Left'][30]),(140,Vector((.146,-.023,0)),yaws['Left'][180]),(188,Vector((.146,-.023,0)),yaws['Left'][180]),(197,idle['Left'],yaws['Left'][197])],
 'Right':[(0,idle['Right'],yaws['Right'][0]),(18,idle['Right'],yaws['Right'][0]),(34,Vector((-.15,-.53,0)),yaws['Right'][35]),(48,Vector((-.15,-.53,0)),yaws['Right'][35]),(64,Vector((.055,-.56,0)),yaws['Right'][84]),(141,Vector((.055,-.56,0)),yaws['Right'][84]),(157,Vector((-.13,.24,0)),yaws['Right'][180]),(170,Vector((-.13,.24,0)),yaws['Right'][180]),(180,Vector((-.135,-.005,0)),yaws['Right'][180]),(188,idle['Right'],yaws['Right'][197]),(197,idle['Right'],yaws['Right'][197])]
}
swings={'Left':[(0,18,.09),(126,140,.07),(188,197,.07)],'Right':[(18,34,.09),(48,64,.07),(141,157,.09),(170,188,.09)]}
def target_at(s,f):
