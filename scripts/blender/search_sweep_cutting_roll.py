...
out.sort(key=lambda r:max(r['nearest14'][0],r['nearest155'][0]));json.dump(out,open(os.path.join(ROOT,'docs/combat-revision/boss-sweep-cutting-roll-feasibility.json'),'w'),indent=2);print(json.dumps(out[:8],indent=1))
