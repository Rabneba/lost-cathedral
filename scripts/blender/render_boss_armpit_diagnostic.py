...
import sys,os
ROOT=os.path.abspath(os.path.join(os.path.dirname(__file__),'../..'));sys.argv=['diagnostic','--','assets/combat-revision/boss/v40-slam-regrip-roll/boss-combat-candidate.blend','slam','docs/combat-revision/armpit-v40','assets/idle-video-motion/scythe-fitted.glb','2.85','1']
