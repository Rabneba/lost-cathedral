...
import json
poses=json.load(open(ROOT+'/assets/player-essential-motion/player-gait-transition-poses.json'))
...
for label,pose in poses.items():
 ...
 scene.render.filepath=ROOT+'/assets/player-essential-motion/gait-transition-review/'+label+'.png';bpy.ops.render.render(write_still=True)
