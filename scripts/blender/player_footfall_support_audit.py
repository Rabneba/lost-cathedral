...
report=json.load(open(ROOT+'/docs/player-footfall-audit.json'))
for variant,path,fps in [('support','assets/player-essential-motion/player-footfall-support-study.blend',30)]:
