...
sourceTag=os.environ.get('VESPER_SWEEP_LEG_SOURCE','sweep-capture-close-3')
bpy.ops.wm.open_mainfile(filepath=ROOT+'/assets/combat-revision/boss/'+sourceTag+'/boss-combat-candidate.blend')
...
json.dump({'rows':rows,'flatHeights':{s:flat[s]['height']for s in flat}},open(ROOT+'/docs/combat-revision/sweep-capture-close3-foot-reach.json','w'),indent=2)
