...
import sys,os
ROOT=os.path.abspath(os.path.join(os.path.dirname(__file__),'../..'));sys.argv=['diagnostic','--','assets/combat-revision/boss/v52-slam-continuous-lowered/boss-combat-candidate.blend','slam','docs/combat-revision/armpit-v52','assets/idle-video-motion/scythe-fitted.glb','2.85','1']
